        ...
        <div className="px-4 py-3">
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-1.5 items-center">
              ...
              <ThemeToggle />
              <Button onClick={() => router.push('/technician/map')} variant="outline" size="sm"><Map className="h-4 w-4" /></Button>
              ...
              <Button onClick={() => fetchAndSortIssues()} variant="outline" size="sm"><RefreshCw className="h-4 w-4" /></Button>
              <Button onClick={handleLogout} variant="outline" size="sm"><LogOut className="h-4 w-4" /></Button>
            </div>
          </div>
        </div>
      </header>
